CREATE TABLE [ukrtax].[level4_keys]
(
...
WITH (SYSTEM_VERSIONING = ON(HISTORY_TABLE=[ukrtax].[level4_keys_HISTORY], DATA_CONSISTENCY_CHECK=ON))
GO

CREATE UNIQUE INDEX [IX_level4_Keys] ON [ukrtax].[level4_keys] ([Key1], [Key2], [Key3], [Key4])
GO