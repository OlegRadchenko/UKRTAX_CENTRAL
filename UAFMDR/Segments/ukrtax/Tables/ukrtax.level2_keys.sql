CREATE TABLE [ukrtax].[level2_keys]
(
...
WITH (SYSTEM_VERSIONING = ON(HISTORY_TABLE=[ukrtax].[level2_keys_HISTORY], DATA_CONSISTENCY_CHECK=ON))
GO

CREATE UNIQUE INDEX [IX_level2_Keys] ON [ukrtax].[level2_keys] ([Key1], [Key2])
GO